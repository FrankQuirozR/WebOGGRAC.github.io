function initMap() {
var map = L.map('map', {center: [-12.056970, -77.084380], zoom: 16, zoomControl: true});
...
var credits;
// Añadir  archivos (gpx, geojson o kml)
var style = {
    color: 'blue',
    opacity: 1.0,
    fillOpacity: 0.0,
...
var left = '<div class="header1">Prototipo de Geoportal para la OGGRAC</div>';
var contents = `
	<div class="content1">
    ...
    <div class="col">
        ...
        <li class="list-inline-item">
            <a class="nav-link active link-light py-0 rounded-0" href="https://www.facebook.com/oggrac" title="Facebook de OGGRAC">
                <img class="fo3" src="img/facebook_4.png">
            </a>
        </li>
        <li class="list-inline-item">
            <a class="nav-link active link-light py-0 rounded-0" href="https://www.instagram.com/oggrac.unmsm/" title="Instagram de OGGRAC">
                <img class="fo3" src="img/ig_4.png">
            </a>
        </li>
        <li class="list-inline-item">
            <a class="nav-link active link-light py-0 rounded-0" href="https://oggrac.unmsm.edu.pe/" title="Página web OGGRAC">
                <img class="fo3" src="img/paginaweb.png">
            </a>
        </li>
         </ul>
    </div>
...
var source = L.WMS.source("http://localhost:8080/geoserver/OGGRAC/wms?", options);

var proyectocampo = source.getLayer('SISMOS');

var alteraciones = source.getLayer('alteraciones');

var estaciones = source.getLayer('mat_const_perim');
...
var dato_estructural = source.getLayer('botadero_residuos');
